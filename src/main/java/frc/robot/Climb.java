...
public class Climb {
    ...
    /**
     * boolean that stops the animator from continueing, automatically sets to false
     * when the animator is finished.
     */
    public boolean cont;
...
class ElevatorArm {
    ...
    public double GetPos() {
        ...
        // perPulse *= 16;//if encoder is on motor, NOT AFTER motor, compensate for
        // gearbox ratio

        // put info in calculator, the double should be percise enough for maximum
        // percision. (perPulse calculation:11 decimals, double's max decimal:16)
        return v / perUnit;
    }
