...
public class Robot extends TimedRobot {
  ...
  // private static final int kDoubleSolenoidForward = 11;
  // private static final int kDoubleSolenoidReverse = 12;
  private static final int xDoubleSolenoidForward = 1;
  private static final int xDoubleSolenoidReverse = 2;
  ...
  public void teleopPeriodic() {
     ...
     */
    if (x_stick.getRawButton(xDoubleSolenoidForward)) {
      m_doubleSolenoid.set(DoubleSolenoid.Value.kForward);
    } else if (x_stick.getRawButton(xDoubleSolenoidReverse)) {
