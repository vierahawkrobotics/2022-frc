...
public class ClimbSim extends TimedRobot {
  public static int kMotorPort = 9;
  private static final int kEncoderAChannel = 0;
  private static final int kEncoderBChannel = 1;
  private static final int kJoystickPort = 0;

  private static final double kElevatorKp = 5.0;
  private static final double kElevatorGearing = 16.0;
  private static final double kElevatorDrumRadius = Units.inchesToMeters(2.0);
  private static final double kCarriageMass = 4.0; // kg

  private static final double kMinElevatorHeight = Units.inchesToMeters(39);
  private static final double kMaxElevatorHeight = Units.inchesToMeters(60.25);
  ...
  private final PWMSparkMax m_motor1 = new PWMSparkMax(kMotorPort);
  ...
  public void simulationPeriodic() {
    ...
    m_elevatorSim.setInput(m_motor1.get() * RobotController.getBatteryVoltage());
